...
```bash
    mvn archetype:generate \
        ...
        -DarchetypeArtifactId=isoftbao-spring-mvc-quickstart \
        -DarchetypeVersion=1.0.0 \
        -DgroupId=my.groupid \
        -DartifactId=my-artifactId \
        -Dversion=version \
        -DarchetypeRepository=https://github.com/isoftbao/spring-mvc-quickstart-archetype
```

Note: The above command will bootstrap a project using the archetype published here: https://github.com/isoftbao/spring-mvc-quickstart-archetype
...
* Set `Group Id` to `com.isoftbao`
* Set `Artifact Id` to `isoftbao-spring-mvc-quickstart`
* Set `Version` to `1.0.0`
* Set `Repository` to `https://github.com/isoftbao/spring-mvc-quickstart-archetype`
...
* Set `Archetype Group Id` to `com.isoftbao`
* Set `Archetype Artifact Id` to `isoftbao-spring-mvc-quickstart`
* Set `Archetype Version` to `1.0.0`
* Set `Repository URL` to `https://github.com/isoftbao/spring-mvc-quickstart-archetype`
...
```bash
    git clone https://github.com/isoftbao/spring-mvc-quickstart-archetype.git
